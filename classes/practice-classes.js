...
// const Baymax = new Character('BAYMAX', 'ROBOT');
...
// let Baymax = new NPC('BAYMAX', 'ROBOT', 'UNIVERSITY', 'I am not fast.');
...
fireSpitter.addSuperPower('dragon breath');
fireSpitter.addSuperPower('harden scales');
